...
### T3 — `/urban-renewal/:neighborhood` (TED-16 §3.2 — shipped TED-93 / ADR-016; 15th neighborhood added TED-97)

| field                    | value                                                                                                                                                                                                                                                 |
| ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Routes                   | `app/routes/$lang.urban-renewal.$slug.tsx`                                                                                                                                                                                                            |
| Variants                 | 15 neighborhoods (`app/lib/urban-renewal/registry.ts`) — 5 original priority neighborhoods + 9 added in TED-93 + 1 added in TED-97 (Kiryat Gat's `komemiyut-yaski-kiryat-gat`, verified via TED-96)                                                   |
| URLs generated           | 15 × 3 = 45                                                                                                                                                                                                                                           |
...
| Known gap                | (resolved TED-97) the 15th Kiryat Gat neighborhood — "מתחם קוממיות-יסקי" / Komemiyut-Yaski — was skipped in TED-93 pending name verification (ADR-016 §D5); verified via minheletgat.co.il in TED-96 and shipped here as `komemiyut-yaski-kiryat-gat` |
...
| URL                           | Topic                                                                | Status                               |
| ----------------------------- | -------------------------------------------------------------------- | ------------------------------------ |
| `/cities/:slug`               | overview (T1, live)                                                  | Live                                 |
| `/cities/:slug/listings`      | redirect → `/listings/:city` (T4) — keep the city slug user-friendly | Planned                              |
| `/cities/:slug/urban-renewal` | filtered T3 view scoped to one city                                  | **Live — shipped TED-94 (7 cities)** |
| `/cities/:slug/professionals` | local pros                                                           | Planned                              |
| `/cities/:slug/mortgage`      | calculator pre-populated for the city + city-specific guidance       | Planned                              |
...
#### `/cities/:slug/urban-renewal` (TED-94)

| field                    | value                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Route                    | `app/routes/$lang.cities.$slug.urban-renewal.tsx`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Variants                 | 7 cities that have ≥1 T3 neighborhood registered: `netanya`, `rishon-lezion`, `rehovot`, `kiryat-gat`, `kiryat-malakhi`, `lod`, `beer-sheva` (`~/lib/urban-renewal/city-aggregate.ts`)                                                                                                                                                                                                                                                                                                                                                                                                                          |
| URLs generated           | 7 × 3 = 21                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Schema                   | `BreadcrumbList` + `ItemList` (each item linking to its neighborhood's own `Place`/`GovernmentService` page — no duplicate `@id`s across pages)                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Variant-specific content | city `overview` (reused from `~/lib/cities/registry.ts`, T1), a summed unit count over neighborhoods with a published numeric figure only (never estimated), deduped citywide qualitative notes, per-neighborhood cards linking to T3                                                                                                                                                                                                                                                                                                                                                                           |
| Internal links           | `/cities/:slug` (back + forward CTA), each aggregated neighborhood's `/urban-renewal/:slug` page, `pinui-binui-tenant-rights` legal-aid entry                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Known gaps               | Netanya's "9 approved renewal projects citywide" and Rishon LeZion's "251 citywide renewal projects" figures cited in the TED-94 spec could not be verified against anything in this repo's registries and were omitted rather than guessed. Be'er Sheva has no citywide unit target for the same reason. Kiryat Gat's aggregate page now shows all 3 registered neighborhoods (`rova-hanevim-kiryat-gat`, `shvat-israel-kiryat-gat`, `komemiyut-yaski-kiryat-gat`) — the TED-94 spec's "3 registered neighborhoods" description is now accurate as of TED-97 (previously only 2 had shipped; see ADR-016 §D5). |
