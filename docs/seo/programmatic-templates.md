...
| Known gaps               | Netanya's "9 approved renewal projects citywide" and Rishon LeZion's "251 citywide renewal projects" figures cited in the TED-94 spec could not be verified against anything in this repo's registries and were omitted rather than guessed. Be'er Sheva has no citywide unit target for the same reason. Kiryat Gat's aggregate page shows its 2 actually-registered neighborhoods (`rova-hanevim-kiryat-gat`, `shvat-israel-kiryat-gat`) — the TED-94 spec described "3 registered neighborhoods," but ADR-016 §D5 confirms only 2 shipped (a 15th/3rd Kiryat Gat neighborhood was deliberately skipped for unverifiable naming); no 3rd was invented to match the spec. |
