# Anchor Partnership Outreach

**Purpose**: Draft outreach for Tier-1 trust anchors per [Vision v2 §"Trust anchors"](../0.1-vision-v2.md) and [research/01-organizations-map.md](../../research/01-organizations-map.md#partnership-strategy-priority-order).

**Why now**: Phases 6 (Health) and 8 (Voice) cannot launch credibly without these anchors. Procurement cycle for established orgs is 30–60 days. Starting today is the only way Phase 6 doesn't slip.
...
## Tier-2/3/4 partnerships (later)

Tier-2 (ENP, Olim Beyahad, Tech-Career, Fidel) — start outreach when Sprint 5 begins (~6 weeks out).
Tier-3 (Council of Kessim, Heritage Center, IAEJ) — Sprint 9.
Tier-4 (govt data sources) — no relationship needed; only adapter monitoring.
