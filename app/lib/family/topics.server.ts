...
const DOMESTIC_VIOLENCE: FamilyTopic = {
  ...
  body: {
    he: `אלימות במשפחה היא עבירה פלילית בישראל — ללא קשר לרקע תרבותי או מסורת. חוק מניעת אלימות במשפחה (1991) מאפשר להוציא צו הגנה תוך שעות. אם את בסכנה — פני לפגוש מיד ל-100 (משטרה) או 1-800-22-0000 (WIZO — קו חינם 24/7).
