...
export const SCHOLARSHIPS_WAVE2: ScholarshipEntry[] = [
  // W2-1. Rashi Foundation — Community Excellence
  {
    ...
    deadline: "rolling",
    applicationUrl: "https://www.rashi.org.il/scholarships",
...
`,
  ...
  // W2-2. Technion Ethiopian Students Fund
  {
    ...
    deadline: "2026-04-01",
    applicationUrl: "https://www.technion.ac.il/scholarships/ethiopian",
...
`,
  ...
  // W2-3. Hebrew University Diversity Scholarship
  {
    ...
    deadline: "2026-03-31",
    applicationUrl: "https://www.huji.ac.il/scholarships/diversity",
...
`,
  ...
  // W2-4. Ministry of Education — Excellence for Periphery
  {
    ...
    deadline: "rolling",
    applicationUrl: "https://www.gov.il/he/departments/moe/excellence-periphery",
...
`,
  ...
  // W2-5. Bizchut Disability + Studies Grant
  {
    ...
    deadline: "rolling",
    applicationUrl: "https://www.bizchut.org.il/students",
...
`,
  ...
  // W2-6. Tel Aviv University Ethiopian Alumni Fund
  {
    ...
    deadline: "rolling",
    applicationUrl: "https://www.tau.ac.il/scholarships/ethiopian-alumni",
...
`,
  ...
  // W2-7. IDF Discharged Soldiers Academic Grant (Ethiopian track)
  {
    ...
    deadline: "rolling",
    applicationUrl: "https://www.aka.idf.il/scholarships",
...
`,
  ...
  // W2-8. Darca High Schools Excellence Scholarship
  {
    ...
    deadline: "rolling",
    applicationUrl: "https://www.darca.org.il/scholarships",
...
`,
  ...
  // W2-9. Ben-Gurion University Social Work Track
  {
    ...
    deadline: "rolling",
    applicationUrl: "https://www.bgu.ac.il/scholarships/social-work",
...
`,
  ...
  // W2-10. Yad Hanadiv Research Fellowship
  {
    ...
    deadline: "2026-01-31",
    applicationUrl: "https://www.yadhanadiv.org.il/research-fellowships",
...
`,
  ...
  // W2-12. Tene Briut Health Professions Scholarship
  {
    ...
    deadline: "2026-05-31",
    applicationUrl: "https://www.tene-briut.org.il/scholarships",
...
`,
  ...
  // W2-13. Immigrant Children Legal Rights Grant (Elem)
  {
    ...
    deadline: "rolling",
    applicationUrl: "https://www.elem.org.il/apply",
...
`,
  ...
  // W2-14. Mandel Foundation Leadership Fellowship
  {
    ...
    deadline: "2026-02-15",
    applicationUrl: "https://www.mandelfoundation.org.il/leadership-fellows",
...
`,
  ...
  // W2-16. Masa Israel Journey — Young Professionals
  {
    ...
    deadline: "rolling",
    applicationUrl: "https://www.masaisrael.org/ethiopia",
...
`,
  ...
  // W2-17. Haifa University Ethiopian Integration Scholarship
  {
    ...
    deadline: "rolling",
    applicationUrl: "https://www.haifa.ac.il/scholarships/integration",
...
`,
  ...
  // W2-19. Na'amat Single-Parent Academic Stipend
  {
    ...
    deadline: "rolling",
    applicationUrl: "https://www.naamat.org.il/scholarships",
