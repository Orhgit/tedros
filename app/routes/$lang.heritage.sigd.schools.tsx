// /:lang/heritage/sigd/schools — what חוק חג הסיגד obliges the education
// system to do, and what a parent can ask for (TED-169).

import type { Route } from "./+types/$lang.heritage.sigd.schools";
...
export async function loader({ params }: Route.LoaderArgs) {
  ...
  return sigdSeasonPayload("schools", locale);
}
...
export default function SigdSchools({ loaderData }: Route.ComponentProps) {
  return (
