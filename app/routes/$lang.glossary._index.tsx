  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main id="main-content" className="container-default mx-auto max-w-5xl py-10">
        <header className="relative mb-10 overflow-hidden rounded-2xl border border-earth-200 bg-linear-to-br from-earth-50 via-background to-accent-sigd/5 px-6 py-8 sm:px-10 sm:py-12">
          <img
