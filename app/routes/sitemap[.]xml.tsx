...
/**
 * Resource route — `/sitemap.xml`. Phase 1/3 stub: homepage + the Phase 3.1
 * mortgage calculator landing page in each locale, with hreflang alternates
 * per ADR-005. Tedros Content & SEO replaces this with a sitemap-index +
 * per-locale per-section sitemaps (cap 40K URLs each) once listings,
 * neighbourhoods, articles and professionals come online.
 */

const STATIC_PATHS = ["", "/calculator/mortgage-ethiopian-immigrants"] as const;
