...
> = {
  he: {
    ...
    kicker: "פלטפורמה",
    intro:
      "תדרוס הוא פורטל קהילתי מקיף ליוצאי אתיופיה בישראל. הפרויקט מאגד מידע, זכויות ושירותים שכבר קיימים — ומתרגם אותם לעברית, אנגלית ואמהרית — כדי להפוך קריאה לפעולה. לא רק לדעת — לקבל. לא רק לבקש — לקבל בחזרה.",
    threeLayers: {
