...
info@tedros.co.il`,
  ...
  {
    name: "תבקה — סיוע משפטי",
    to: "info@tebeka.org.il",
    targetUrl: `${BASE_URL}/he/rights`,
    targetAnchor: "מדריך זכויות יוצאי אתיופיה",
    subject: "שיתוף פעולה — מדריך זכויות טדרוס ותבקה",
    bodyHe: `שלום לצוות תבקה,

אנחנו טדרוס — פורטל קהילתי שמרכז זכויות ושירותים ליוצאי אתיופיה בישראל בשלוש שפות.

בנינו מדריך זכויות מפורט שמציין את תבקה כגוף הפנייה המרכזי לייצוג משפטי — ומפנה אליכם ישירות מכל דף זכות רלוונטי: ${BASE_URL}/he/rights
